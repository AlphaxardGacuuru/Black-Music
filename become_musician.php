...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			<br class="hidden">
			<ol>
				<h4>Once you become a musician you can upload songs and post on the home page and users can buy, like or comment. Users can buy songs via mpesa to our Mpesa till. Users can also invite others and earn each time their invites buy songs.</h4><br>
				<h3>Payment</h3>
				<li><h4><small>Payment is done via Mpesa to </small><span style='color: dodgerblue;'> 
					<?php 
				...
				<br>
				<h3>Password</h3>
				<li>Once you become a musician your password will be set as your phone number (<?php echo $phone; ?>).</li>
				<li>You can later change this in settings.</li><br>
				<br>
				<h3>Decos</h3>
	...
	<div class="row">
		<div class="col-sm-12">
			<center>
				<?php
				if (empty($name)) {
					echo "<h5 class='error'>Name empty, please go to settings and update your name before becoming a musician!</h5>";
				} elseif (empty($email)) {
					echo "<h5 class='error'>Email empty, please go to settings and update your email before becoming a musician!</h5>";
				} else {
					echo "<a href='admin_actions.php?user_id=$user_id&from=studio' class='btn sonar-btn'>become a musician</a>";
				}
				?>
			</center>
		</div>
